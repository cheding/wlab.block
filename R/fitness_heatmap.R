...
fitness_heatmap<-function(
  ...
  ggplot2::ggplot()+
    ...
    ggplot2::theme(text = ggplot2::element_text(size=5),
                   ...
                   axis.text.x = ggplot2::element_text(size =6, angle=90, vjust=.5, hjust=1),
                   axis.text.y = ggplot2::element_text(family="Courier",angle=90,size=6, vjust =.5,hjust =.5,margin=ggplot2::margin(0,-0.5,0,0,"mm")),
